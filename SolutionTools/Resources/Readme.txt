...
4.1. ProjectCreator.exe
  ...
  The executable searches for ProjectCreator.cfg to find the locations of scripts and projects.
...
7. [optional, highly recommended] Use the refactoring tool on all scripts.
...
Maintenance:
  ...
  - Occasionally use the refactoring tool on all scripts.
